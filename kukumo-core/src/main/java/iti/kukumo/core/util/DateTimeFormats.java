...
public final class DateTimeFormats {
    ...
    private record FormatStyles(FormatStyle date, FormatStyle time) { }
    ...
    private static String patternToRegex(String formatPattern) {
        ...
        while (parser.hasMoreTokens()) {
            ...
            if (nextToken.equals(" ")) {
                ...
                if (regexSymbol == null) {
                    throw new KukumoPluginException("Date/time format symbol '{}' has no equivalent regex", nextToken);
                }
